...
path_articles = "s3://aws-logs-815402967860-us-east-2/elasticmapreduce/cloudcomputing/articles"
...
df_inverted_indices.write.format("jdbc").options(
    url="jdbc:mysql://cloudcomputing.cmv8nu6m6bzm.us-east-2.rds.amazonaws.com:3306/news?serverTimezone=UTC", 
    driver="com.mysql.jdbc.Driver", 
    dbtable="inverted_index",
    user="cloudcomputing", 
    password="cloudcomputing").mode('append').save()
